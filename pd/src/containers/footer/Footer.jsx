    ...
    <div className="gpt3__footer-links">
      ...
      <div className="gpt3__footer-links_div">
        <div className="linkers">
          ...
          <p><InstagramIcon className="InstagramIcon" onClick={() => window.open('https://instagram.com/placingdreams?igshid=YmMyMTA2M2Y=')} style={{ fontSize: 50, marginRight: 20  }} /></p>
          <p><FacebookIcon className="fbIcon" onClick={() => window.open('https://www.facebook.com/placingdreamsinstitute/')} style={{ fontSize: 50 }} /></p>
