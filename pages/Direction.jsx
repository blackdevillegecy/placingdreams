...
function Direction() {
  ...
  return (<div className='body2'>
    ...
    <h1 className='main' style={{background: 'linear-gradient(90deg, #EE82EE 0%, #00D1FF 100%)', backgroundClip: 'text', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent'}}>Direction<br/><br/></h1>
      <p>A Director is a story-tylffil'uh[iul;ddi;eller. He takes the Script and transform it into a visual experience. He has to have an in-depth understanding of Screenwriting, Acting, Cinematography, Editing, Sound, Production in process of a film making.</p><br/><br/>
