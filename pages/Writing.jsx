...
function Writing() {
  return (<div className='body2'>
    ...
    <p>Screenwriting is one of the most lucrative career in the recent times and hence the film city is seeing a rapid growth in the number of people trying to get a grasp in this field. Screenwriting is an art which requires imagination, every decision made by them can completely
      change how the audience feel the emotions and how they interpret it. 
      ...
      One of the key roles of a writer in the film industry is to develop interesting and complex characters. Good characters are the driving force of any story, and a good writer can create characters that are nuanced, relatable, and believable. They can also create compelling dialogue that helps to reveal the characters&apos; personalities and motivations.
      To become a writer in Bollywood, one typically needs to have a passion for storytelling and the ability to craft engaging and compelling stories. Writing for Bollywood films also requires a deep understanding of the industry and the audiences it serves, as well as the ability to create characters and stories that resonate with Indian audiences.
      Another important role of a writer in the film industry is to structure the story in a way that is engaging and satisfying to audiences. A good writer knows how to create a strong narrative arc that keeps the audience invested in the story and builds tension and suspense. They also know how to use setting, dialogue, and other elements of the screenplay to create a unique and compelling visual world for the film.
      Overall, a good writer is an essential part of any film production, and can help ensure that the final product is engaging, well-written, and emotionally resonant.
      Students at Placing Dreams get to make short films international festivals and from students get to learn a lot and experiment with their skills, which also helps themi dentify what they are good at. The mind 
