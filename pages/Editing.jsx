...
function Editing() {
  return (
    ...
    <h1 className='main' style={{background: 'linear-gradient(90deg, #EE82EE 0%, #00D1FF 100%)', backgroundClip: 'text', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent'}}>Film Editing<br/><br/></h1>
      ...
      An editor plays a crucial role in the movie industry. They are responsible for shaping the story and creating the final cut of a film.
...
Editors also work closely with the director to ensure that the film stays within its allocated budget and production schedule. They must be able to make creative decisions quickly and efficiently in order to meet these constraints.

In short, an editor is a vital member of the movie-making team. Their creativity, technical skills, and collaboration with the director are essential for creating a successful film.
        At Placing Dreams, every student and nurtured to become the best version of themselves and are expected to become the best in the industry. Students get several opportunities to work as interns for big production houses and get a secure job in this field. As budding editors, the students also get to work on different mini-projects to showcase their talents and make a mark for themselves. We help the student to track their performance and get better everyday with the help of our
