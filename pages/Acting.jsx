...
function Acting() {
  return (<div className='body2'>
    ...
    <h1 className="main" style={{background: 'linear-gradient(90deg, #EE82EE 0%, #00D1FF 100%)', backgroundClip: 'text', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent'}}>Acting<br/><br/></h1>
      ...
      The values of disicipline and willingness to make scarifice is ingrained in every student from the beginning. The opportunities are plenty, all one need is dedication and hard work. The syllabus followed at the institute is handcrafted by the experts in the industry and tries to shed light on all the dark corners which might be left in the courses by other institutions.
      </p>
