...
function Acting() {
  return (<div className='body2'>
    ...
    <h1 className="main" style={{background: 'linear-gradient(90deg, #EE82EE 0%, #00D1FF 100%)', backgroundClip: 'text', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent'}}>Acting<br/><br/></h1>
      ...
      Students of Placing Dreams get the best possible training from the best people in the field. Nearly every student from the institute get to start with a project from recognsed media houses. At Placing Dreams Students are taught to treat work like worship, 
      The values of disicipline and willingness to make scarifice is ingrained in every student from the beginning. The opportunities are plenty, all one need is dedication and hard work. The syllabus followed at the institute is handcrafted by the experts in the 
      ...
      <p>
        ...
        <h4> Module 2</h4>
      <p>Movie Analysis<br/><br/>
          Character Analysis<br/><br/>
          Play Back<br/><br/>
          Diction<br/><br/>
         </p>
         <h4> Module 3</h4>
...
Basics of Audition<br/><br/>
Audition Analysis<br/><br/>
Preparation Of Audition<br/><br/>
Audition Performance<br/><br/>
How to make Self test<br/><br/>
Personality Development Sessions<br/><br/>
Conclusion<br/><br/>
<br/><br/>
Will Do Play /Monolouge/ Scene Work/ Short Film/Series<br/><br/>
          </p>
    </div>
    </div>
  );
